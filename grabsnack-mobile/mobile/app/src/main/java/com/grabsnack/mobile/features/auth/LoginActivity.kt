...
import com.grabsnack.mobile.features.dashboard.DashboardActivity
import com.grabsnack.mobile.shared.network.LoginRequest
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvRegisterLink.text = Html.fromHtml(
            getString(R.string.no_account), Html.FROM_HTML_MODE_LEGACY)
                    ...
                    override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                        ...
                        if (response.isSuccessful) {
                            ...
                            Toast.makeText(this@LoginActivity,
                                response.errorBody()?.string() ?: "Invalid credentials", Toast.LENGTH_SHORT).show()
                        }
                    }
